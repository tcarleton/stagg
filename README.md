...
spline_output <- staggregate_spline(
  ...
  knot_locs = c(-1.665335e-16,      # Where to place the knots. Most likely,  
                -1.665335e-16,      # you'd want to calculate different 
                1.129775e-06,       # quantiles in your daily gridded values and 
                3.852533e-04,       # choose knot locations based on those
                1.594356e-02)
)
```
