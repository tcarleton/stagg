...
# Introduction
This article demonstrates how to use the `stagg` package with data from `climateR`, as well as other data sources that do not have temporal metadata in a format that `stagg` accepts in the layer names. 

First, we load the packages used in this article. 
